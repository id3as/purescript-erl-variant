...
foreign import matchImpl :: forall r a b. Record r -> VariantRep a -> b

foreign import unsafeHas :: forall r1. ErlAtom.Atom -> Record r1 -> Boolean

foreign import unsafeGet :: forall r a. ErlAtom.Atom -> Record r -> a
